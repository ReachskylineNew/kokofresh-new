              ...
              <div className="space-y-10 sm:space-y-12">
                ...
                <div className="p-6 sm:p-8 bg-gradient-to-r from-[#FED649]/25 via-[#DD9627]/15 to-[#B47B2B]/10 border border-[#FED649]/50 rounded-2xl shadow-inner">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-serif font-semibold text-[#DD9627] mb-2 text-lg">Pro Tip</h4>
                      <p className="text-[#3B2B13]/90 text-sm sm:text-base leading-relaxed">
                        Warm a spoon of ghee or sesame oil before mixing — this enhances the aroma and brings out the
                        rich, nutty flavour of Bengal Gram Chutney Powder.
                      </p>
                    </div>
                  </div>
                </div>
